import{_ as a,c as n,o as s,a as t}from"./app.f3bcd0c3.js";const h='{"title":"Basic Usage","description":"","frontmatter":{},"headers":[{"level":2,"title":"Custom language","slug":"custom-language"}],"relativePath":"guide/basic-usage.md","lastUpdated":1638781399784}',p={},e=t(`__VP_STATIC_START__<h1 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a></h1><p>Once the plugin is registered you can straight up use it in your app.</p><div class="language-vue"><div class="highlight-lines"><br><div class="highlighted">\xA0</div><br><br><br><br><br><br><br><div class="highlighted">\xA0</div><br><br><br><br><br><br></div><pre><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
...
</code></pre></div>__VP_STATIC_END__`,9),o=[e];function c(l,u,i,r,k,d){return s(),n("div",null,o)}var m=a(p,[["render",c]]);export{h as __pageData,m as default};
